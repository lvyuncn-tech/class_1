...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-violet-50 text-slate-800 font-sans selection:bg-violet-100">
      <main className="max-w-md mx-auto min-h-screen bg-violet-50 relative">
        <div className="p-6">
           {renderView()}
        </div>
      </main>
