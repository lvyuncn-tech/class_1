...
const Dashboard: React.FC<DashboardProps> = ({ habits, todayLogs }) => {
  ...
  return (
    <div className="space-y-6 pb-20 animate-fade-in">
      ...
      {/* Progress Card */}
      <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-3xl p-6 shadow-sm border border-pink-100 flex items-center justify-between">
        <div>
